        ...
        jsonwebtoken_1.verify(token, process.env.SECRET_KEY, (err, decoded) => __awaiter(void 0, void 0, void 0, function* () {
            if (err) {
                jsonwebtoken_1.verify(rf_token, process.env.SECRET_KEY, (err, refreshDecode) => __awaiter(void 0, void 0, void 0, function* () {
                    if (!err) {
                        const retrieve = yield Rider_1.Rider.findOne({ where: { id: refreshDecode.payload.id } });
                        context.req.headers["access_token"] = (yield config_1.accessToken(retrieve));
                        context.req.headers["refresh_token"] = (yield config_1.refreshToken(retrieve.id));
                    }
                    else {
