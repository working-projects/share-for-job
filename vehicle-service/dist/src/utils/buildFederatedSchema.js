...
function buildFederatedSchema(options, referenceResolvers) {
    return __awaiter(this, void 0, void 0, function* () {
        const schema = yield type_graphql_1.buildSchema(Object.assign(Object.assign({}, options), { directives: [...graphql_1.specifiedDirectives, ...directives_1.default, ...(options.directives || [])], skipCheck: true }));
        const federatedSchema = federation_1.buildFederatedSchema({
            typeDefs: graphql_tag_1.default(federation_1.printSchema(schema)),
            resolvers: type_graphql_1.createResolversMap(schema),
        });
