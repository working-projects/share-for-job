...
let StatusInput = (() => {
    let StatusInput = class StatusInput {
    };
    __decorate([
        class_validator_1.Length(1, 255),
        type_graphql_1.Field(),
        __metadata("design:type", String)
    ], StatusInput.prototype, "userId", void 0);
    __decorate([
        type_graphql_1.Field(() => statusEnumType_1.Status),
        __metadata("design:type", String)
    ], StatusInput.prototype, "status", void 0);
    StatusInput = __decorate([
        type_graphql_1.InputType()
    ], StatusInput);
    return StatusInput;
})();
exports.StatusInput = StatusInput;
//# sourceMappingURL=updateStatusinput.js.map