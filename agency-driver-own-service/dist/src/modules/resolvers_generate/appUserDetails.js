...
exports.ADetailsAgencyResolver = exports.ADetailsDriverResolver = void 0;
...
function CreateResolver(suffix, retunType, entity, middleware) {
    let BaseResolver = (() => {
        let BaseResolver = class BaseResolver {
            listOfUser(userId) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const user = yield entity.findOne({ where: { id: userId } });
                    if (!user) {
        ...
        __decorate([
            type_graphql_1.Query(() => retunType, { name: `app_details${suffix}` }),
...
exports.ADetailsDriverResolver = CreateResolver("Driver", detailsDriver_1.DetailsDriverResponse, Driver_1.Driver, [isAuthMiddleware_1.isAuthMiddleware]);
exports.ADetailsAgencyResolver = CreateResolver("Agency", detailsAgency_1.DetailsAgencyResponse, Agency_1.Agency, [isAuthMiddleware_1.isAuthMiddleware]);
//# sourceMappingURL=appUserDetails.js.map