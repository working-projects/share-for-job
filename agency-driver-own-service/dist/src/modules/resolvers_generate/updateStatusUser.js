...
exports.UpStatusAgencyResolver = exports.UpStatusDriverResolver = void 0;
...
const updateStatusinput_1 = require("./types/updateStatusinput");
...
function CreateResolver(suffix, inputType, entity, middleware) {
    let BaseResolver = (() => {
        ...
        __decorate([
            type_graphql_1.Mutation(() => createResponse_1.CreateResponse, { name: `updateStatus${suffix}` }),
...
exports.UpStatusDriverResolver = CreateResolver("Driver", updateStatusinput_1.StatusInput, Driver_1.Driver, [isAuthMiddleware_1.isAuthMiddleware]);
exports.UpStatusAgencyResolver = CreateResolver("Agency", updateStatusinput_1.StatusInput, Agency_1.Agency, [isAuthMiddleware_1.isAuthMiddleware]);
//# sourceMappingURL=updateStatusUser.js.map