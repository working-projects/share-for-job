...
exports.deleteAgency = exports.deleteDriver = void 0;
...
function CreateResolver(suffix, entity, middleware) {
    let BaseResolver = (() => {
        ...
        __decorate([
            type_graphql_1.Mutation(() => createResponse_1.CreateResponse, { name: `delete${suffix}` }),
...
exports.deleteDriver = CreateResolver("Driver", Driver_1.Driver, [isAuthMiddleware_1.isAuthMiddleware]);
exports.deleteAgency = CreateResolver("Agency", Agency_1.Agency, [isAuthMiddleware_1.isAuthMiddleware]);
