...
const authTokens_1 = require("./sheared/authTokens");
const typeorm_1 = require("typeorm");
const tokenType_1 = require("../types/tokenType");
let RefreshTokenResolver = (() => {
    let RefreshTokenResolver = class RefreshTokenResolver {
        createAgencyRefreshToken(token) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const user = yield Agency_1.Agency.findOne({ id: payload.userId });
                if (!user) {
                    throw new Error("User not found");
                }
                if (user.tokenVersion !== payload.tokenVersion) {
                    const updateTokenVersion = yield typeorm_1.getConnection().getRepository(Agency_1.Agency).increment({ id: payload.userId }, "tokenVersion", 1);
    ...
    ], RefreshTokenResolver.prototype, "createAgencyRefreshToken", null);
    RefreshTokenResolver = __decorate([
        type_graphql_1.Resolver()
    ], RefreshTokenResolver);
    return RefreshTokenResolver;
})();
