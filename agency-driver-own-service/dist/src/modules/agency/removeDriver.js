...
exports.ReomveDriverResolver = void 0;
...
let ReomveDriverResolver = (() => {
    let ReomveDriverResolver = class ReomveDriverResolver {
        removeDriverFromAgency({ payload }, id) {
                ...
                if ((user === null || user === void 0 ? void 0 : user.status) === statusEnumType_1.Status.PENDING) {
                    ...
                    try {
                        yield typeorm_1.getConnection().createQueryBuilder()
                            .relation(Agency_1.Agency, "drivers")
                            .of({ id: user === null || user === void 0 ? void 0 : user.id })
                            .remove(driver.id);
                        return true;
                    }
                    catch (error) {
    ...
    ], ReomveDriverResolver.prototype, "removeDriverFromAgency", null);
    ReomveDriverResolver = __decorate([
        type_graphql_1.Resolver()
    ], ReomveDriverResolver);
    return ReomveDriverResolver;
})();
exports.ReomveDriverResolver = ReomveDriverResolver;
//# sourceMappingURL=removeDriver.js.map